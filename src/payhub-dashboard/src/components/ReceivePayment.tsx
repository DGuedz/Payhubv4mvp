...
import { QrCode, Copy, Check, X, ArrowDownRight, RefreshCw } from 'lucide-react';
      ...
      <div className="bg-[#1A1F2B] rounded-t-2xl md:rounded-2xl w-full md:max-w-lg max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          {qrCodeGenerated || method === 'xrpl' ? (
            <div className="bg-[#0F1218] border border-gray-800 rounded-xl p-8">
              {/* Mock QR Code */}
              ...
              {method === 'xrpl' && (
                <div className="mt-4 p-3 rounded-lg bg-[#2979FF]/5 border border-[#2979FF]/20">
                  <p className="text-xs text-gray-400">
                    ℹ️ Conversão automática RLUSD → R$ com yield de 5-8% APY
                  </p>
                </div>
              )}
            </div>
